...
$DATABASE::conf{'test'} = {
    max_retries => 2,
    db_stack => [
        [ 'dbi:NullP:server=prod1;database=test', 'user1', 'password1', $dbixha_attr ],
        [ 'dbi:NullP:server=prod2;database=test', 'user2', 'password2', $dbixha_attr ],
        [ 'dbi:NullP:server=prod3;database=test', 'user3', 'password3', $dbixha_attr ],
        ],
    pingtimeout     => -1,
