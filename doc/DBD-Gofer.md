...
Multiple resultsets are supported only if the driver supports the more\_results() method
...
See ["Using DBI\_AUTOPROXY"](#using-dbi_autoproxy) below for an example.
